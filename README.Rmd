...
Amazon classification using Landsat collection (1996 - 2022) for Region 2 defined in the scope of the Restore+ Project.
...
Next, open the `classification-amazon-region-2` directory in the RStudio and install the examples package:
